...
export function XocoWeather() {
  const { data, isLoading } = useSWR<WeatherResponse>('/api/xoco/weather', fetcher, { refreshInterval: 900_000 })
  ...
  return (
    <div>
      ...
      <div className="section-title">Weather — El Lago, Nicaragua</div>
